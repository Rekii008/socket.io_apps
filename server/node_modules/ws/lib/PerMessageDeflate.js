...
function PerMessageDeflate(options, isServer) { //{threshold:1024}, true <- default
...
PerMessageDeflate.prototype.accept = function(paramsList) {
  paramsList = this.normalizeParams(paramsList);  //return [{"client_max_window_bits":true}]

  var params;
  if (this._isServer) {
    params = this.acceptAsServer(paramsList); //accept {}
  } else {
...
PerMessageDeflate.prototype.acceptAsServer = function(paramsList) { //[{"client_max_window_bits":true}]
  var accepted = {};
